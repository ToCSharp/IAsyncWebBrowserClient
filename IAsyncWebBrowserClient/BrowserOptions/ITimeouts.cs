...
namespace Zu.WebBrowser.BrowserOptions
{
    ...
    public interface ITimeouts
    {
        ...
        /// </para>
        /// </remarks>
        Task SetImplicitWait(TimeSpan implicitWait, CancellationToken cancellationToken = default(CancellationToken));
        Task<TimeSpan> GetImplicitWait(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// method.
        /// </summary>
        Task SetAsynchronousJavaScript(TimeSpan time, CancellationToken cancellationToken = default(CancellationToken));
        Task<TimeSpan> GetAsynchronousJavaScript(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// property.
        /// </summary>
        Task SetPageLoad(TimeSpan time, CancellationToken cancellationToken = default(CancellationToken));
        Task<TimeSpan> GetPageLoad(CancellationToken cancellationToken = default(CancellationToken));
    }
}